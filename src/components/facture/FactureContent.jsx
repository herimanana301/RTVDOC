        ...
        <Text fz="xs">
          <div style={{ display: "flex", justifyContent: "space-between" }}>
            <span style={{ fontWeight: "bold" }}>
              <div style={{ display: "flex" }}>
                <img
                  src="https://rtvsoafia.mg/storage/2022/02/pdp3.png"
                  alt="logo"
          ...
          <div style={{ display: "flex", flexDirection: "column" }}>
            ...
            <div style={{ fontWeight: "bold" }}>
              <span style={{ textDecoration: "underline" }}>Doit </span>
              {"Herimanana Rasolonirina"}
              <br />
              suivant BC {"N°UMT/010100305/10-23UMATEC"} du {"16/10/23"}
            </div>
            <br />
        ...
        <Text fz={"sm"}>
          ...
          >
            <span style={{ display: "flex", alignItems: "center" }}>
              <p>TOTAL HT: </p> {"totalHorsTaxe"}
            </span>
            <span style={{ display: "flex", alignItems: "center" }}>
              <p>TVA 20%: </p> {"tva"}
            </span>
            <span style={{ display: "flex", alignItems: "center" }}>
              <p>TOTAL TTC: </p> {"totalTTC"}
            </span>
          </div>
          <div style={{ textAlign: "center" }}>
            <p>
              Arrêté la présente facture à la somme de:{" "}
              <span>{"Valeur en lettres"}</span>
            </p>
            <span>
